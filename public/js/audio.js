...
const { setUsername, getUsername } = require('./log.mjs');
...
const createAudioElement = (audioBlob, sender) => {
  ...
  audioPlayer.title = getUsername();

  const messageContainer = document.createElement('div');
  messageContainer.classList.add('message');
  messageContainer.classList.add(sender === getUsername() ? 'sent' : 'received');
...
const setUsernameAndInitWebSocket = () => {
  setUsername();
  initWebSocket();
};

setUsernameAndInitWebSocket();
